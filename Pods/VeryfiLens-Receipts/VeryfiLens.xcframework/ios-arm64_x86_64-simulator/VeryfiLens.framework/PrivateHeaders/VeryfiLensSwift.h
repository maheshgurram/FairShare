...
typedef SWIFT_ENUM(NSInteger, DocumentType, closed) {
    DocumentTypeLongReceipt,
    DocumentTypeReceipt,
    DocumentTypeBill,
    DocumentTypeCheck,
    DocumentTypeCreditCard,
    DocumentTypeBusinessCard,
    DocumentTypeOther,
    DocumentTypeCustom
};
...
- (void)createPackageForCredentials:(VeryfiLensCredentials * _Nonnull) credentials
                          settings: (VeryfiLensSettings * _Nonnull)  settings
                 customPackageInfo: (CustomPackageInfo * _Nullable) customPackageInfo
                         completion: (void (^_Nonnull)(NSString * _Nonnull packageID)) completion;

- (void)createPackageWithMultipleImagesForCredentials:(VeryfiLensCredentials * _Nonnull) credentials
                          settings: (VeryfiLensSettings * _Nonnull)  settings
                 customPackageInfo: (CustomPackageInfo * _Nullable) customPackageInfo
                                           completion: (void (^_Nonnull)(NSArray<NSString *> * _Nonnull packages)) completion;
...
#pragma mark -
#pragma mark - EmailCCViewController

SWIFT_CLASS("EmailCCViewController")
@interface EmailCCViewController : UIViewController<UIAdaptivePresentationControllerDelegate,ExposedViewController>
@end
...
#pragma mark -
#pragma mark - LensSettingsViewControllerDelegate

SWIFT_PROTOCOL("LensSettingsViewControllerDelegate")
@protocol LensSettingsViewControllerDelegate <NSObject>
- (void) restartCameraWithNewSettings;
@end

#pragma mark -
#pragma mark - LensSettingsViewController

SWIFT_CLASS("LensSettingsViewController")
@interface LensSettingsViewController : UIViewController<UIAdaptivePresentationControllerDelegate>
@property (nonatomic, weak) id <LensSettingsViewControllerDelegate> _Nullable delegate;
@end
//
//#pragma mark -
...
SWIFT_CLASS("VoiceViewController")
@interface VoiceViewController : UIViewController<ExposedViewController>
@property (nonatomic) NSString * _Nullable sourceVC;
@end
...
#pragma mark -
#pragma mark - SceneFactory
SWIFT_CLASS("SceneFactory")
@interface SceneFactory: NSObject
+ (VoiceViewController * _Nonnull)voiceSceneWithCompletion:(nullable void (^)(bool success)) completion;
+ (EmailCCViewController * _Nonnull)emailSceneWithCompletion:(nullable void (^)(bool success)) completion;
@end
